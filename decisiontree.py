...
print("=== Decision Tree Forecast: Next 3 Months ===")
...
plt.plot(future_dates, predictions, label="Decision Tree Forecast", marker='x', color='red')
plt.title("Monthly Sales Forecast using Decision Tree")
plt.xlabel("Date")
plt.ylabel("Sales (₱)")
plt.legend()
plt.grid(True)
