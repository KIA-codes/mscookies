...
# ==== Residual Modeling (Decision Tree) ====
...
tree_model.fit(X_time, y_resid)
resid_pred = tree_model.predict(X_time)
...
metrics_df = pd.DataFrame({
    ...
    "ARIMA + DecisionTree": compute_metrics(
...
future_hybrid = future_forecast.values + tree_model.predict(future_X)
