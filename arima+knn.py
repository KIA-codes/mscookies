...
results = []
for i in range(1, len(test_series)):   # start at 1 so train has at least 1 observation
    train = test_series[:i]
...
future_hybrid = future_forecast.values + knn.predict(future_X)
