# %% ARIMA + Gradient Boosting Hybrid (Cleaned Version)
import pandas as pd
import numpy as np
...
metrics_df = pd.DataFrame({
    ...
    "ARIMA + GradientBoost": compute_metrics(
...
# ==== Output ====
print("\n=== Metrics (ARIMA + Gradient Boosting) ===")
