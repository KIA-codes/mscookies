# %% Holt-Winters + Random Forest Hybrid Forecast
import pandas as pd
import numpy as np
...
# ==== Residual Modeling with Random Forest ====
...
all_months["RF_Hybrid_Forecast"] = all_months["Forecasted_Sales"] + resid_pred
all_months["Difference_RF"] = all_months["Actual_Sales"] - all_months["RF_Hybrid_Forecast"]
all_months["Reached_RF"] = np.where(all_months["Actual_Sales"] >= all_months["RF_Hybrid_Forecast"], "Yes", "No")
...
metrics_df = pd.DataFrame({
    ...
    "HW + RandomForest": compute_metrics(all_months["Actual_Sales"], all_months["RF_Hybrid_Forecast"], all_months["Reached_RF"])
})

# ==== 12-Month Future Forecast (Random Forest Hybrid) ====
...
print("\n=== 12-Month Future Forecast (Hybrid with RF) ===")
