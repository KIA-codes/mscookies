...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user_code && $session_code && $user_code == $session_code) {
        // ✅ Code matched, allow password reset
...
<body>
   ...
   <img src="nobackgroundlogo.png" alt="logo" width="700" height="200" style="position: absolute;
    ...
    <div class="login-container">
        ...
        <div class="login-title"> <h2>Enter Verification Code</h2>
    <p>We've sent a 6-digit code to your email.<br>Please enter it below.</p></div>
     <?php if ($error): ?>
  ...
  <polyline points="8 6 2 12 8 18" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <input type="text"  name="code" placeholder="Enter 6-digit code" required style="padding-left:38px;" required maxlength="6" pattern="\d{6}">
                </div>
            </div>
            <div class="form-group">
                <div class="input-wrapper">
